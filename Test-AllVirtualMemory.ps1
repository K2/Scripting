...
if($GUIOutput -eq $true) {
	...
	Out-SquarifiedTreeMap -InputObject $Procs.Children -Width 1024 -Height 768 -DataProperty Size -HeatmapProperty Heat -LabelProperty Label -ShowLabel {"$($This.LabelProperty)"}
}
